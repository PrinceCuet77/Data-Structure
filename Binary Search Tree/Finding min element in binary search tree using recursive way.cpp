...
int findingMax(BstNode *root) {
        ...
        int leftMax = findingMax(root->leftChild); // Minimum value got from left subtree
        int rightMax = findingMax(root->rightChild); // Minimum value got from right subtree
...
int main()
{
        ...
        printf("Minimum in binary search tree : %d\n", findingMax(root));
